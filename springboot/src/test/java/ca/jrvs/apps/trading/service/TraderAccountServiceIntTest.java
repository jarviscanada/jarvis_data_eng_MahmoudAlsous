...
public class TraderAccountServiceIntTest {
    ...
    public void createTraderAndAccount() {
        ...
        savedView = traderAccountService.createTraderAndAccount(savedTrader2);

        assertEquals(savedTrader2.getId(), savedView.getAccount_id());
        assertEquals(savedTrader2.getCountry(), savedView.getCountry());
    }
