...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    public Customer findById(long id) {
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(GET_ONE);){
            ...
            CustomerDAO.logger.error("Error: Method findById() failed", e);
    ...
    public Customer update(Customer dto) {
        ...
        try{
            ...
            CustomerDAO.logger.error("Error: setAutoCommit() failed");
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(UPDATE);){
            ...
            try{
                ...
                CustomerDAO.logger.error("Error: rollback() failed.");
                throw new RuntimeException();
            }
    ...
    public Customer create(Customer dto) {
        try(PreparedStatement statement = this.connection.prepareStatement(INSERT);){
            ...
            CustomerDAO.logger.error("Error: Cannot create new Customer data", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public void delete(long id) {
        try(PreparedStatement statement = this.connection.prepareStatement(DELETE);){
            ...
            CustomerDAO.logger.error("Error: Cannot delete Customer data", e);
            throw new RuntimeException(e);
        }
    }
}
